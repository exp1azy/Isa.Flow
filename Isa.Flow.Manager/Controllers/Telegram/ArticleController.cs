...
namespace Isa.Flow.Manager.Controllers.Telegram
{
    /// <summary>
    ...
    public class ArticleController : Controller
    {
            ...
            bool sortDirection, int pageSize, int page, CancellationToken cancellationToken)
        {
            ...
            return View(await _articleService.GetSortedChannelPostsAsync(id, pubDate, sortField, sortDirection, pageSize, page, searchText, cancellationToken));
        }
    }
}
