...
using Isa.Flow.Manager.Models.Telegram;
using Isa.Flow.Manager.Models.Telegram.ViewModels;

namespace Isa.Flow.Manager.Services
{
    /// <summary>
    ...
    public class ArticleService
    {
        ...
        public async Task<ArticlesViewModel> GetSortedChannelPostsAsync(int id, string? pubDate, string? sortField, bool sortDirection, int pageSize, int page, string searchText, CancellationToken cancellationToken)
        {
